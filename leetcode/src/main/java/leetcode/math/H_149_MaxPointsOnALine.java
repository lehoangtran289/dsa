...
public class H_149_MaxPointsOnALine {
    public static void main(String[] args) {
        int[][] input = new int[][]{{1, 1}, {3, 2}, {5, 3}, {4, 1}, {2, 3}, {1, 4}};
        System.out.println(new H_149_MaxPointsOnALine().maxPoints(input));

        int[][] input2 = new int[][]{{1, 1}, {0, 0}, {1, -1}};
        System.out.println(new H_149_MaxPointsOnALine().maxPoints(input2));

        int[][] input3 = new int[][]{{2, 3}, {3, 3}, {-5, 3}};
        System.out.println(new H_149_MaxPointsOnALine().maxPoints(input3));
    }
